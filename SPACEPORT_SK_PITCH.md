...
**Prečo to je pre Spaceport_SK dôležité:** program cieli aj na **študentské tímy** — a ja mám pripravený backlog, do ktorého viem okamžite zapojiť 2 študentov (napr. z FIIT STU / FEI STU / FRI UNIZA). To je unikátny škálovací plán, ktorý iní účastníci pravdepodobne nemajú.
...
- **Plánovaný expansion**: 2 študenti (z FIIT STU / FEI STU / FRI UNIZA — presné kontakty finalizované počas apríla), podľa `FEATURE-v2-ext.md` Epic assignment.
...
3. **Študentský scale-up plán je ambiciózny.** Reálne viem získať 2 študentov za týchto podmienok? Treba potvrdiť s kontaktami na STU/UNIZA do konca marca 2026.
...
- [ ] Oslov STU/UNIZA kontakty o potenciálnych študentoch na `FEATURE-v2-ext.md` tickety.
...
10. **Predbežný kontakt so študentmi** na STU/UNIZA.

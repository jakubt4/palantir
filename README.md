...
│  │               │                │    │  │  UdpTmDataLink :10000 │  │  │
│  │  ┌────────────▼─────────────┐  │    │  │         │             │  │  │
│  │  │ OrbitPropagationService  │  │    │  │  IssPacketPreprocessor │  │  │
│  │  │ TLE → SGP4 → WGS84 LLA  │  │    │  │  (CFS checksum valid) │  │  │
│  │  │ @Scheduled(1 Hz)         │  │    │  │         │             │  │  │
│  │  └────────────┬─────────────┘  │    │  │  XTCE MDB Decoder     │  │  │
│  │               │                │    │  │  /Palantir/Latitude    │  │  │
│  │  ┌────────────▼─────────────┐  │    │  │  /Palantir/Longitude  │  │  │
...
The telemetry packet follows CCSDS 133.0-B-1 with an appended CFS-style running 16-bit checksum for compatibility with Yamcs `IssPacketPreprocessor`.
...
The CFS checksum algorithm sums all 16-bit words (big-endian) from byte 0 through byte 17, masked to 16 bits. Yamcs validates this checksum before decoding the packet via XTCE.
...
| **Telemetry** | CCSDS Space Packet | 133.0-B-1 | Binary packet encoding with CFS checksum over UDP |
...
└── yamcs/                                    # Custom Yamcs Docker image
    ...
    │   ├── yamcs.palantir.yaml               # Instance — UdpTmDataLink, IssPacketPreprocessor
...
| **Preprocessor** | `IssPacketPreprocessor` | Validates CFS 16-bit checksum, extracts sequence count |
...
- [x] CFS-compatible running 16-bit checksum for IssPacketPreprocessor
